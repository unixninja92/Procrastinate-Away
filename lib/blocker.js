...
(function() {
  this.Blocker = (function() {
    ...
    Blocker.prototype.getMessage = function() {
      return this.message;
    };

    Blocker.prototype.clearList = function() {
      return this.list = [];
    };

    Blocker.prototype.reload = function() {
      return StorageArea.get("todos", function(items) {
        items.length;
        return this.list = items[0];
      });
    };

    Blocker.prototype.isLoggedIn = function() {
    ...
    Blocker.prototype.parseJson = function(json) {
      ...
      this.list = json.urls;
      return this.isWhitelist = json.whitelist;
    };
